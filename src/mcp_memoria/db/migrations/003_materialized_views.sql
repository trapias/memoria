...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_matviews WHERE matviewname = 'monthly_work_summary') THEN
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_matviews WHERE matviewname = 'daily_work_totals') THEN
